...
@testset "Energy" begin
    ...
    Λ0 = Φ * Φ'
    @test Eana ≈ tr(h * Λ0) rtol = 1.0e-5
    # Diagonalize the correlation matrix as a
    # Gaussian MPS (GMPS) and GMERA
    ngmps, V1 = ITensorGaussianMPS.correlation_matrix_to_gmps(Λ0; eigval_cutoff = 1.0e-8)
    nmera, V1 = ITensorGaussianMPS.correlation_matrix_to_gmera(Λ0; eigval_cutoff = 1.0e-8) #,maxblocksize=6)
